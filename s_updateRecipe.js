...
const handlerWrapperArgs = { functionName: 'yummying-bird-serverless-api-dev-updateRecipe', timeout: 6 };

try {
  const userHandler = require('./src/lambda/recipe/updateRecipe.js');
